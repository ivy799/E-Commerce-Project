        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white light:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 light:text-gray-100">
                    {{-- <h3 class="text-lg font-medium text-gray-900 light:text-gray-100">{{ __('Product List') }}</h3> --}}
                    <ul class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        @foreach ($products as $product)
                            <li class="bg-white light:bg-gray-700 p-4 rounded-lg shadow">
                                <a href="{{ route('buyer.products.show', $product->id) }}">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <p class="text-gray-900 light:text-gray-100 font-bold">{{ $product->price }}</p>
                                    </div>
                                </a>
                            </li>
                        @endforeach
