        ...
        <div class="bg-gray-50 text-black/50 light:bg-black dark:text-white/50">
            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <!-- Search Form -->
                    <form action="{{ route('welcome.search') }}" method="GET" class="mb-6">
                    ...
                    <form action="{{ route('filter') }}" method="GET" class="p-6 bg-white shadow-lg rounded-lg mb-6" id="filterForm">
                        <div class="mb-4">
                            <h4 class="text-xl font-semibold text-gray-800 mb-4 border-b pb-2">Categories</h4>
                        ...
                        <button 
                            type="submit" 
                            class="w-fit bg-black hover:bg-white hover:text-black text-white font-semibold py-2 px-4 rounded-lg shadow-lg transition duration-200 ease-in-out border-solid border-black"
                            id="filterButton"
                        >
                            Filter
                        </button>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        if (shopNowButton) {
            shopNowButton.addEventListener("click", (e) => {
                ...
                const targetSection = document.querySelector("#productlist");
                if (targetSection) {
